...
from texmega import texmega_no_stanza
...
def buildLemmaPosCache(model, nlp_it, cache_name):
    ...
    elif nlp_it is not None and not os.path.exists(cache_path) and not os.path.exists(cache_7zip_path):
